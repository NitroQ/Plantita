                            ...
                            <div class="grid grid-cols-1 shadow-cardShadow border border-white rounded-xl bg-white">
                                    ...
                                    <div class="grid grid-cols-6 items-center justify-center p-4 px-6">
                                        ...
                                        <div class=" col-span-4 pr-6">
                                            <div class="grid grid-rows-1 ">
                                                ...
                                                <h4 class="font-brandon-regular text-lg text-gray-500 pr-6">A tropical plant
                                                    with striking foliage that resembles an...</h4>
                                ...
                                <div class="flex flex-col md:flex-row justify-between">
                                    <div class="flex  p-4">
                                        ...
                                        <span
                                            class="text-sm bg-green-100 text-green-200 uppercase font-brandon-black px-3 py-2 rounded">Shipped</span>
                                    </div>
                                    <div class="flex p-4 items-center">
                                        ...
                                        <button
                                            class="text-sm p-2 bg-green rounded-md uppercase font-extrabold text-white ml-4">Products
                                            Received</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 shadow-cardShadow border border-white rounded-xl bg-white">
                                ...
                                <div class="flex flex-col md:flex-row justify-between">
                                    <div class="flex  p-4">
                                        <h4 class="font-brandon-regular text-xl text-gray-500 mr-4">Order Status:</h4>
                                        <span
                                            class="text-sm bg-blue-100/10 text-blue-100 uppercase font-brandon-black px-3 py-2 rounded">Done</span>
                                    </div>
                                    <div class="flex p-4 items-center">
                                        <h4 class="font-brandon-regular text-xl text-gray-500">Order Total:</h4>
                                        <h4 class="font-brandon-bold text-xl text-green-200 font-bold  ml-2">₱2,250</h4>
