    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 h-screen w-full py-0">
        ...
        <div class="flex flex-col justify-center">
            ...
            <form class="max-w-[500px] w-full mx-auto text-center p-8 px-8 " action="{{ route('authenticate') }}"
                ...
                <div class="flex justify-between py-2">
                    ...
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox"
                            class="w-4 h-4 text-green bg-gray-100 border-gray-300 rounded focus:ring-green">
                ...
                {{-- SIGN IN BUTTON --}}
                <button type="submit" class="w-full my-5 py-2 bg-green rounded-md uppercase font-extrabold text-white">Sign
                    In</button>
