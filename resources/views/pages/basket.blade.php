        ...
        <tbody>
          ...
          <tr class="bg-white text-black border-b">
            <td class="px-6 py-4 flex items-center">
              <input type="checkbox" class="w-4 h-4 text-green-200 border-gray-500/50 rounded focus:ring-green-200 dark:focus:ring-green-200 focus:ring-2">
              <img src="{{ asset('images/products/plant-sample.webp') }}" class="h-28 w-28 object-cover mx-5 rounded-lg" />
              <div>
                <h4 class="text-2xl font-brandon-bold">African Mask</h4>
                <p class="text-gray-500/70 w-3/5 max-h-20 overflow-hidden line-clamp-2">The African Mask plant, with its striking arrowhead-shaped leaves, adds a touch of exotic elegance to any space. Known for its unique pattern resembling an African tribal mask, this plant is a stunning choice for plant enthusiasts and interior decor enthusiasts alike.</p>
              </div>
            </td>
            <td class="px-6 py-4 font-brandon-bold text-xl">₱<span>500</span></td>
            ...
            <td class="px-6 py-4 font-brandon-bold text-xl">₱<span>1000</span></td>
