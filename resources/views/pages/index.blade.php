  ...
  <section class="">
    ...
    <div class="my-10">
      <div class="flex flex-col gap-y-2">
        ...
        <p class="text-lg lg:w-[56%] w-full">
          ...
          tools, our best sellers are sure to elevate your home and garden.
        </p>
      </div>
    </div>
    ...
    <div class="my-10 flex justify-center items-center">
      <a href="" class="bg-green-200 uppercase text-white font-brandon-bold text-md rounded-md py-2 px-3">SHOW MORE
        PLANTS</a>
    </div>
  </section>
