          ...
          <div class="my-10">
              ...
              <div class="grid lg:grid-cols-2 my-10 gap-x-4 lg:gap-y-0 gap-y-3">
                  <div
                      ...
                      <div class="absolute z-10 px-10 top-5">
                          <div class="flex justify-center flex-col xl:h-80 lg:h-72 h-full w-full">
                              ...
                              <div class="self-start mt-auto">
                                  <div
                                      class="flex bg-white items-center justify-center p-3 lg:w-12 w-10 lg:h-12 h-10  rounded-full">
                                      <a href="">
                      ...
                      <div class="bg-light-green-pattern home__img-overlay absolute w-full bottom-0 h-[50vh] rounded-md">
                      </div>
                  </div>
                  <div
