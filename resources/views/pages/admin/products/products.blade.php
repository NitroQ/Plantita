  ...
  <section>
    <div class="flex justify-between mb-5">
      ...
      <div class="more-actions space-x-3 flex items-center">
        ...
        <a href="{{ route('add-product') }}"><button class="bg-green-200 text-white py-2 px-5 rounded hover:bg-green-200/90">Add Inventory</button></a>
      </div>
    </div>
        ...
        <tbody class="text-lg border-b border-gray-500/20">
          <tr class="bg-white border-b border-gray-500/20">
            ...
            <td class="px-6 py-3 space-x-2">
              <a href="{{ route('view-product') }}"><button><i class='bx bxs-show bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
              <a href="{{ route('edit-product') }}"><button><i class='bx bxs-pencil bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
            </td>
          </tr>
          <tr class="bg-white border-b border-gray-500/20">
            <th scope="row" class="px-6 py-3 font-medium whitespace-nowrap">
