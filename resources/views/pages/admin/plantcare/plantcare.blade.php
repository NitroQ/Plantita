      ...
      <tbody class="text-lg border-b border-gray/20">
        <tr class="bg-white border-b border-gray/20">
          ...
          <td class="px-6 py-3 space-x-2">
            <a href="{{ route('view-plantinfo') }}"><button><i class='bx bxs-show bg-culture p-2 rounded hover:bg-green/20'></i></button></a>
            <a href="{{ route('edit-plantinfo') }}"><button><i class='bx bxs-pencil bg-culture p-2 rounded hover:bg-green/20'></i></button></a>
          </td>
        </tr>
        <tr class="bg-white border-b border-gray/20">
          <th scope="row" class="px-6 py-3 font-medium whitespace-nowrap">
