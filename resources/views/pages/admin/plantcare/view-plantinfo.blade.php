    ...
    <div class="grid grid-cols-4 gap-8 items-start">
      <div class="col-span-5 lg:col-span-2 shadow-leftBottom p-5 rounded-md space-y-3">
        ...
        <div class="space-y-2">
          ...
          <select id="care-level" class="border border-lavender rounded-lg focus:ring-green/20 focus:border-green/20 block w-full px-3.5 py-2.5" disabled>
          ...
          <textarea id="message" rows="4" placeholder="Write description here..." class="block px-3.5 py-2.5 w-full border border-lavender rounded-lg resize-none focus:ring-green/20 focus:border-green/20" disabled>The African Mask plant falls into the category of medium care. While it's not the most demanding plant, it does require a bit of attention to thrive. It's not the best choice for beginners, but with some experience and care, you can successfully grow and maintain this striking plant.
              </textarea>
        </div>
        <div class="space-y-2">
          <label for="watering-level" class="text-xl font-brandon-bold block">Watering Level</label>
          <select id="watering-level" class="border border-lavender rounded-lg focus:ring-green/20 focus:border-green/20 block w-full px-3.5 py-2.5" disabled>
        ...
        <div class="space-y-2">
          ...
          <select id="sunlight-level" class="border border-lavender rounded-lg focus:ring-green/20 focus:border-green/20 block w-full px-3.5 py-2.5" disabled>
        ...
        <button class="bg-green text-white py-2 rounded hover:bg-green/90"><a href="{{ route('edit-plantinfo') }}" class="py-2 px-5">Edit Details</a></button>
      </div>
