      ...
      <div class="grid grid-cols-4 gap-8 items-start">
        <div class="col-span-5 lg:col-span-2 shadow-leftBottom p-5 rounded-md space-y-3">
          ...
          <div class="space-y-2">
            ...
            <select id="care-level" class="border border-lavender rounded-lg focus:ring-green-200/20 focus:border-green-200/20 block w-full px-3.5 py-2.5">
          ...
          <div class="space-y-2">
            ...
            <select id="watering-level" class="border border-lavender rounded-lg focus:ring-green-200/20 focus:border-green-200/20 block w-full px-3.5 py-2.5">
          ...
          <div class="space-y-2">
            ...
            <select id="sunlight-level" class="border border-lavender rounded-lg focus:ring-green-200/20 focus:border-green-200/20 block w-full px-3.5 py-2.5">
          ...
          <button class="bg-green-200 text-white py-2 rounded hover:bg-green-200/90"><a href="{{ route('view-plantinfo') }}" class="py-2 px-5">Save Details</a></button>
        </div>
