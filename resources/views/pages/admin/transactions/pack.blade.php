  ...
  <div class="grid grid-cols-5 gap-8 items-start">
    <div class="col-span-5 lg:col-span-2 space-y-8">
      ...
      <div class="space-y-3">
        ...
        <input id="shipment" type="text" class="block w-full col-span-2 rounded-lg border border-lavender px-3.5 py-2.5 focus:ring-green/20 focus:border-green/20" placeholder="Choose Courier">
        <input id="shipment" type="text" class="block w-full col-span-2 rounded-lg border border-lavender px-3.5 py-2.5 focus:ring-green/20 focus:border-green/20" placeholder="Courier Location">
        <input id="shipment" type="number" class="block w-full col-span-2 rounded-lg border border-lavender px-3.5 py-2.5 focus:ring-green/20 focus:border-green/20" placeholder="Tracking/Reference No.">
        <div class="grid grid-cols-3 space-x-3 pt-3">
          ...
          <button class="bg-blue text-white text-lg py-2 rounded hover:bg-blue/80"><i class='bx bx-printer me-3'></i>Print Waybill</button>
          <button class="bg-green text-white text-lg py-2 rounded hover:bg-green/80"><a href="{{ route('shipped') }}"><i class='bx bxs-truck me-3'></i>Ship Item</a></button>
        </div>
      </div>
    </div>
