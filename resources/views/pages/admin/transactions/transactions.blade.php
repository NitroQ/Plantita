  ...
  <section>
    ...
    <div class="relative overflow-x-auto">
        ...
        <tbody class="text-lg border-b border-gray-500/20">
          <tr class="bg-white border-b border-gray-500/20">
            ...
            <td class="px-4 lg:px-6 py-3 space-x-2">
              <a href="{{ route('view-transaction') }}"><button><i class='bx bxs-show bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
              <a href="{{ route('pending') }}"><button><i class='bx bxs-pencil bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
            </td>
          </tr>
          <tr class="bg-white border-b border-gray-500/20">
            <th scope="row" class="px-6 py-3 font-medium whitespace-nowrap">
            ...
            <td class="px-4 lg:px-6 py-3 space-x-2">
              <a href="{{ route('view-transaction') }}"><button><i class='bx bxs-show bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
              <a href="{{ route('pack') }}"><button><i class='bx bxs-pencil bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
            </td>
          </tr>
          <tr class="bg-white border-b border-gray-500/20">
            <th scope="row" class="px-6 py-3 font-medium whitespace-nowrap">
            ...
            <td class="px-4 lg:px-6 py-3 space-x-2">
              <a href="{{ route('view-transaction') }}"><button><i class='bx bxs-show bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
              <a href="{{ route('shipped') }}"><button><i class='bx bxs-pencil bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
            </td>
          </tr>
          <tr class="bg-white border-b border-gray-500/20">
            <th scope="row" class="px-6 py-3 font-medium whitespace-nowrap">
            ...
            <td class="px-6 py-3">
              <span class="text-sm bg-blue-100/20 text-blue-100 uppercase font-brandon-black px-3 py-2 rounded">Done</span>
            </td>
            <td class="px-6 py-3 font-brandon-bold">
              ₱1,500.00
            </td>
            <td class="px-4 lg:px-6 py-3 space-x-2">
              <a href="{{ route('view-transaction') }}"><button><i class='bx bxs-show bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
              <a href=""><button><i class='bx bxs-pencil bg-gray-400 p-2 rounded hover:bg-green-200/20'></i></button></a>
            </td>
          </tr>
        </tbody>
      </table>
      <div class="flex items-center space-x-3 my-5">
        ...
        <div class="flex items-center">
          <div class="packed h-4 w-4 bg-yellow me-2"></div>
