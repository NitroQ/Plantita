  ...
  <div class="grid grid-cols-5 gap-8 items-start">
    <div class="col-span-5 lg:col-span-2 space-y-8">
      ...
      <div class="space-y-3">
        ...
        <input id="shipment" type="number" class="block w-full col-span-2 rounded-lg border border-lavender px-3.5 py-2.5 focus:ring-green/20 focus:border-green/20" placeholder="Input Number">
        <div class="grid grid-cols-3 space-x-3 pt-3">
          ...
          <button class="bg-yellow text-lg py-2 rounded hover:bg-yellow/80"><a href="{{ route('pack') }}"><i class='bx bx-package me-3'></i>Item Prepared</a></button>
        </div>
      </div>
    </div>
