  ...
  <section class="">
    <div class="grid grid-cols-12 gap-5">
      <div class="space-y-4 col-span-8 flex flex-col justify-center">
        ...
        <a href="{{ route('product') }}" class="flex-none text-md inline-block rounded-md bg-green-200 hover:bg-green-200/80 px-4 py-2 font-brandon-bold uppercase w-32 text-center text-white">SHOP NOW</a>
      </div>
    ...
    <div class="py-5">
      ...
      <div class="grid lg:grid-cols-2 my-10 gap-x-4 lg:gap-y-0 gap-y-3">
        <div class="bg-[url('../../public/images/home/home-cactusplant.webp')] relative bg-cover bg-center bg-no-repeat w-full h-[40vh] rounded-md">
          <a href="{{ route('product') }}">
            ...
            <div class="bg-light-green-pattern-full home__img-overlay absolute w-full bottom-0 h-[40vh] rounded-md"></div>
          </a>
        </div>
    ...
    <div class="my-10 flex justify-center items-center">
      <a href="{{ route('product') }}" class="bg-green-200 hover:bg-green-200/80 uppercase text-white font-brandon-bold text-md rounded-md py-2 px-3">SHOW MORE
        PLANTS</a>
    </div>
  </section>
