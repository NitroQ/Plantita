            ...
            <div id="under-plants" class="hidden" aria-labelledby="plants-drop">
              <ul class="space-y-2 py-5 pl-12 pr-5">
                <li class="flex justify-between items-center">
                  ...
                  <label class="text-lg" for="plants-all">All</label>
                  <input type="checkbox" name="categories[]" value="Plant" id="plants-all" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Plant', $categories) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="bush">Bush</label>
                  <input type="checkbox" name="types[]" value="Bush" id="bush" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Bush', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="flowering">Flowering</label>
                  <input type="checkbox" name="types[]" value="Flowering" id="flowering" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Flowering', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="shrub">Shrub</label>
                  <input type="checkbox" name="types[]" value="Shrub" id="shrub" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Shrub', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="succulent">Succulent</label>
                  <input type="checkbox" name="types[]" value="Succulent" id="succulent" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Succulent', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="perennial">Perennial</label>
                  <input type="checkbox" name="types[]" value="Perennial" id="perennial" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Perennial', $types) ? 'checked' : '' }}>
                </li>
              </ul>
            </div>
            ...
            <div id="under-essentials" class="hidden" aria-labelledby="essentials-drop">
              <ul class="space-y-2 py-5 pl-12 pr-5">
                <li class="flex justify-between items-center">
                  ...
                  <label class="text-lg" for="ess-all">All</label>
                  <input type="checkbox" name="categories[]" value="Essential" id="ess-all" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Essential', $categories) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="soil">Soil</label>
                  <input type="checkbox" name="types[]" value="Soil" id="soil" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Soil', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="pots">Pots</label>
                  <input type="checkbox" name="types[]" value="Pots" id="pots" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Pots', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="watering">Watering</label>
                  <input type="checkbox" name="types[]" value="Watering" id="watering" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Watering', $types) ? 'checked' : '' }}>
                </li>
                <li class="flex justify-between items-center">
                  <label class="text-lg" for="gardening">Gardening</label>
                  <input type="checkbox" name="types[]" value="Gardening" id="gardening" class="checked:bg-green w-4 h-4 rounded-sm" {{ in_array('Gardening', $types) ? 'checked' : '' }}>
                </li>
              </ul>
            </div>
          </form>
