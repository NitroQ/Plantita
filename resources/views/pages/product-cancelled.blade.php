...
<div class="grid xl:grid-cols-6 grid-cols-1 h-full w-full py-0">
  ...
  <div class="col-span-5 p-6 flex items-center justify-start">
    <div class="grid grid-cols-1 px-6 py-4">
      ...
      <h2 class="font-brandon-black text-green text-5xl pt-6 py-4">Purchase Cancelled!</h2>
      <p class="text-gray text-xl pb-2">You cancelled your current purchase. You can go back to your cart to proceed item checkout.</p>
