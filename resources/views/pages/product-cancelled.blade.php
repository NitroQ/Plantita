...
<div class="grid xl:grid-cols-6 grid-cols-1 h-full w-full py-0">
  ...
  <div class="col-span-5 p-6 flex items-center justify-start">
    <div class="grid grid-cols-1 px-6 py-4">
      <img class="w-50 h-50 object-cover py-6 max-w-3/4 mx-0 mr-4" src="{{ asset('images/error/product-cancelled-vector.webp') }}" alt="watering can and plant">
      <h2 class="font-brandon-black text-green-200 text-5xl pt-6 py-4">Purchase Cancelled!</h2>
      <p class="text-gray-500 text-xl pb-2">You cancelled your current purchase. You can go back to your cart to proceed item checkout.</p>
