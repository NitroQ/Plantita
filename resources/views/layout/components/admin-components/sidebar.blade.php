  ...
  <nav class="h-full flex flex-col justify-between overflow-hidden text-xl md:px-2 lg:px-8 py-3">
    <div>
      ...
      <ul class="space-y-3">
        ...
        <li><a href="{{ route('admin.products.index') }}" class="{{ request()->is('admin/products') ? 'bg-green-200/10' : '' }} p-2 flex items-center lg:justify-start justify-center rounded-md hover:bg-green-200/10">
        ...
        <li><a href="{{ route('admin.plantcare.index') }}" class="{{ request()->is('admin/plantcare') ? 'bg-green-200/10' : '' }} p-2 flex items-center lg:justify-start justify-center rounded-md hover:bg-green-200/10">
