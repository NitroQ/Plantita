<aside class="fixed overflow-hidden w-80 h-full bg-background">
    <nav class="h-full flex flex-col justify-between overflow-hidden text-xl px-8 py-3">
        <div>
            ...
            <div class="pt-3">
                <h5 class="font-bold text-base uppercase">Administrative Portal</h5>
        ...
        <ul class="my-3">
            <li><a href="#" class="p-2 flex items-center justify-between rounded-md hover:bg-green/10">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-base font-bold leading-5">Frank Vincent Gesmundo</p>
